 ...
 */
$config['alias'] = array(
	'Role/1' => 'Role/invitado',
	'Role/2' => 'Role/editor',
	'Role/3' => 'Role/administrador',
);
...
$config['rules'] = array(
    'allow' => array(
        '*' => 'Role/administrador',
        'controllers/pages/home' => 'Role/invitado',
        'controllers/pages/testui' => 'Role/invitado',
        'controllers/pages/testajax' => 'Role/invitado',
        'controllers/pages/tab1ajax' => 'Role/invitado',
        'controllers/pages/testpermisos' => 'Role/invitado',
        'controllers/instits/(index|view)' => 'Role/invitado',
        'controllers/instits/(add|edit)' => 'Role/editor',
        'controllers/jurisdicciones/(index|view)' => 'Role/editor',
        'controllers/jurisdicciones/(add|edit)' => 'Role/editor',
        'controllers/jurisdicciones/verdatospersonales' => 'Role/editor',
        'controllers/localidades/(index|view)' => 'Role/invitado',
        'controllers/localidades/(add|edit)' => 'Role/editor',
        'controllers/departamentos/(index|view)' => 'Role/editor',
        'controllers/departamentos/(add|edit)' => 'Role/editor',
        'controllers/tipoinstits/(index|view)' => 'Role/editor',
        'controllers/tipoinstits/(add|edit)' => 'Role/editor',
),
