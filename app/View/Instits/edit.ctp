...
<?php echo $this->Form->create('Instit'); ?>
	<fieldset>
		<legend><?php echo __('Edit Instit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Instit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Instit.id'))); ?></li>
