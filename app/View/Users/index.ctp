<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('oficina'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['oficina']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['interno']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['role']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['jurisdiccion_id']); ?>&nbsp;</td>
